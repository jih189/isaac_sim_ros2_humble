...
namespace CUDAMPLib {
    ...
    std::string SingleArmSpace::generateFKKernelSourceCode()
    {
        ...
        // set for joint_poses
        kernel_source_code += "__constant__ float joint_poses[" + std::to_string(num_of_links * 4 * 4) + "] = \n";
        kernel_source_code += "{\n";
        ...
        // set for joint_axes
        kernel_source_code += "__constant__ float joint_axes[" + std::to_string(num_of_links * 3) + "] = \n";
        kernel_source_code += "{\n";
...
__device__ __forceinline__ void kin_forward(float * configuration, float * self_collision_spheres)
{
        ...
        kernel_source_code += "    float full_joint_values[" + std::to_string(num_of_joints) + "];\n";
        // set default values
        int local_dim = 0;
        for (int i = 0; i < num_of_joints; i++)
        {
        ...
        kernel_source_code += "    float link_poses[" + std::to_string(num_of_links * 16) + "];\n";
