 ...
 */
void TEST_COLLISIONS(const moveit::core::RobotModelPtr & robot_model, rclcpp::Node::SharedPtr node, bool debug = false)
{
...
int main(int argc, char** argv)
{
    ...
    TEST_COLLISIONS(kinematic_model, cuda_test_node);
